        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             I’m an aspiring Data Scientist with a growing interest in software engineering and cloud technologies. I enjoy learning how to turn ideas into real-world digital solutions and building projects that combine data and innovation.

My long-term dream is to use data and technology to fight against climate change — by developing sustainable, tech-driven solutions that make a positive impact on the world.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1dhZUzzVSnsWu8iNCgRRFPKcsKtwlrDPj/view?usp=sharing" className="w-full lg:w-auto" target="_blank" rel="noopener noreferrer">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
