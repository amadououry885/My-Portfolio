...
// import Komentar from "../components/Commentar"; // Temporarily disabled - requires database
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl = 'https://formsubmit.co/amadouodiallo77@gmail.com';
    ...
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
         ...
         Interested in working together or have a question? Feel free to reach out—I’ll respond shortly.
      ...
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12" >
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Do you have something to discuss? Send me a message and let’s talk..
                </p>
              </div>
          ...
          {/* Comment section temporarily disabled - requires database */}
